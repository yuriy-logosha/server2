...
/usr/bin/java -Dscope=today -Dthreads=10 -Xms256m -Xmx1g -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=75 -XX:+UseCMSInitiatingOccupancyOnly -XX:+HeapDumpOnOutOfMemoryError -XX:+DisableExplicitGC -jar /home/ubuntu/sslv/target/sslv-0.0.1-SNAPSHOT-with-dependencies.jar start -d -p /var/run/sslvlauncher/sslvlauncher.pid
